...
const Testimonials = ({ isDarkMode }) => {
  ...
  return (
    <section
      id="testimonials"
      className={`py-24 transition-colors duration-300 ${isDarkMode ? "bg-brand-charcoal/50 text-white" : "bg-brand-light-gray/30 text-brand-charcoal"}`}
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Kepercayaan Anda adalah prioritas kami. Berikut adalah beberapa
          ...
          {reviews.map((rev, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <p
                  className={`text-lg italic leading-relaxed mb-8 relative z-10 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
                >
                  "{rev.text}"
                </p>
              </div>
